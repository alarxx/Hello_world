...
class MyCarousel {
    ...
    constructor(VISIBLE_N=3, HEIGHT=-1, WIDTH=240){
        ...
        this.#carousel.style.textAlign = "center";
        ...
        buttons.appendChild(this.#prevBtn);
    ...
    #createBtn(isNext){
        ...
        btn.style.margin = "0.5rem 0.5rem 1rem 0.5rem";

        const ic = document.createElement("i");
        ic.setAttribute("style", "font-size:24px");
...
class AdaptiveCarousel {
  ...
  #ns(){
    return this.#containerWidth < 720 ? 2 : (this.#containerWidth < 960 ? 3 : 5);
  }
