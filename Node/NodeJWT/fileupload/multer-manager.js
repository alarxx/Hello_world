...
async function _clearTemp({ force, tmpDir, clearTmpTime }){
    try{
...
object.initialize = function(opts={}){
    // Default values
    if(!opts.clearTmpTime){
        opts.clearTmpTime = 1000 * 60 * 60 * 5; // 5 hours
    }
    if(!opts.clearTmpIntervalTime){
        opts.clearTmpIntervalTime = 1000 * 60; // 1 minute
    }
    if(!opts.tmpDir){
